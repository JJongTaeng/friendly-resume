...
eval("module.exports = JSON.parse('{\"browserTitle\":\"이력서 - 조인태\",\"title\":\"즐거움과 편리함을 주는 개발자\",\"aboutMe\":\"안녕하세요. 1년 차 웹 프론트엔드 엔지니어 조인태입니다. 현재 리액트를 주로 사용하여 웹/앱 환경의 애플리케이션 개발을 하고 있습니다. 저는 Vanilla JavaScript를 좋아합니다.\",\"links\":[{\"name\":\"github\",\"link\":\"https://github.com/jjongtaeng\"},{\"name\":\"notion\",\"link\":\"https://notion.com\"},{\"name\":\"blog\",\"link\":\"https://jointae.tistory.com/\"}],\"workExperience\":[{\"company\":\"알서포트\",\"period\":\"2022.01.03 ~\",\"projects\":[{\"name\":\"RemoteView Box\",\"description\":\"Remote View 서비스의 사용할 수 없는 환경에서 사용하기 위해 장치인 Box의 관리자 페이지를 구성했습니다.\",\"link\":\"https://content.rview.com/ko/\",\"myRole\":[\"아직 진행중인 프로젝트~!\",\"아직 진행중인 프로젝트~!\",\"아직 진행중인 프로젝트~!\"]}]},{\"company\":\"캐시스\",\"period\":\"2020.11.19 ~ 2021.12.23\",\"projects\":[{\"name\":\"DC 마이크로그리드\",\"description\":\"태양광 발전소 ~ 주택의 전기 공급과 사용 데이터를 시각화하여 차트와 흐름도로 표현한 실시간 관제 시스템입니다.\",\"myRole\":[\"실시간으로 데이터를 차트와 흐름도로 시각화하였습니다.\",\"백엔드를 스프링 프레임워크를 사용하여 직접 구현하였습니다.\",\"장치의 운전 및 정지 제어 명령 기능을 구현하였습니다.\"]}]}],\"otherExperience\":[{\"title\":\"Webdow10\",\"period\":\"2021.09.01 ~ 2021.09.11\",\"link\":\"https://webdow10.herokuapp.com/\",\"description\":[\"윈도우 테마의 UI/UX를 웹으로 표현한 사이트\",\"webcomponents API를 사용하여 구현\"]}],\"skills\":[{\"title\":\"JavaScript\",\"description\":[\"ES6+ 이후 문법에 익숙하고 최신 동향에 관심이 많습니다.\",\"Web API, DOM API를 능숙하게 다룹니다.\",\"Prototoype 기반의 OOP 개념을 이해하고 활용합니다.\",\"내부 코드에서 this를 알고 어떤 바인딩이 좋은 코드인지를 압니다.\",\"렉시컬 환경의 이해와 그에 맞는 코드 스타일 구사합니다.\",\"구현에 있어 브라우저 렌더링, 렌더 트리에 대한 내용을 고려합니다.\"]},{\"title\":\"TypeScript\",\"description\":[\"기본 타입, 이넘, 인터페이스, 제너릭, 클래스 등 기본적인 TypeScript를 구사합니다.\",\"유틸 타입(Pick, Omit, Patial)을 구사합니다.\",\"라이브러리를 사용함에 있어서 타입을 부여합니다.\"]}]}');\n\n//# sourceURL=webpack://friendly-resume/./public/resume.json?");
